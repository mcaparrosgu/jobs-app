...
| T101 | 8 · Media | Publicar a `master`, con tu permiso explícito. **Intentado el 24/08** (push directo, sin pasar por T100 — riesgo aceptado explícitamente por Mar): el robot bloqueó el despliegue por NO CONCLUYENTE (ver T95). La URL pública sigue en el estado de dos días antes | — | La URL pública sirve la versión nueva | T95 | [ ] |
