...
| T95 | 2 · Crítica | Relanzar `npm run evals` completo (las dos llamadas) y confirmar que la puerta ya no da ROJO. **1er intento (24/08 mañana): NO CONCLUYENTE** — los 13 casos de `generarCvYCarta` fallaron por timeout de Cloudflare, cero señal de contenido (ver T102-T104). Repetir con cuota fresca, idealmente antes de que entren las usuarias mañana | `evals/` | `npm run evals:puerta` sobre el resultado nuevo da VERDE (o al menos ya no las mismas señales de contenido) | T94, T102, T103 | [ ] |
